...
// deno-lint-ignore-file no-explicit-any ban-types no-empty-interface

/**
 * Provides a scaffold of JSX types intended to be neutral to a specific JSX
 * implementation.  Largely borrowed from [preact](https://preactjs.com/) type
 * definitions.
 *
 * @module
 */
...
type RenderableProps<P, RefType = any> =
  & P
...
declare namespace JSX {
  ...
  export interface HTMLAttributes<RefType extends EventTarget = EventTarget>
    extends ClassAttributes<RefType>, DOMAttributes<RefType> {
